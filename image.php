...
<div class="singup">
	...
	<div class="singup" style="overflow: auto;">
	<?php
...
{
echo "<script type= 'text/javascript'>alert('That file name already exists.Please try again.');window.location = \"image.php\"</script>";
		exit();
}else
{
...
<form action="imagereg.php" method="post">
...
{
echo "<script type= 'text/javascript'>alert('That file is not valid.Please try again.');window.location = \"image.php\"</script>";
		exit();
}
}
	?>
